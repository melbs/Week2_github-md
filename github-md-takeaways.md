...
with that concept in mind, really makes things make sense. 

For example:

- Using all 1s is reinforcing that idea. The 1. is a tag or a identifier that a structure is being used
- So the 2, 3, 4 isn't needed. That is actually more of the "presentation" verse content.

## Bonus takeaway: I love the block coding

Probably my favorite Markdown has been using the back ticks for code. Whether it's inline code using a
